...
class Term4list extends StatelessWidget {
  String gclassname;
  final String userid;
  final String classname;
  final List<String> subjectid;
  final String indexnumber;
  Term4list({this.userid, this.classname, this.subjectid, this.indexnumber});
  String subjectval;
